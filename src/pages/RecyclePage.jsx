...
function RecyclePage() {
    return (
        <div className='w-full min-h-screen flex flex-col items-center justify-center gap-10 bg-center bg-no-repeat bg-[url("https://th.bing.com/th?id=OIP.ajEWaL9mTXt_gzJMkphe-wHaHR&w=252&h=247&c=8&rs=1&qlt=90&o=6&dpr=1.5&pid=3.1&rm=2")] '>
